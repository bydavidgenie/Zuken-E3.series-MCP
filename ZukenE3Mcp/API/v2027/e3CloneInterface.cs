...
{
    public class e3CloneInterface : IDisposable
    {
        private readonly Zuken.E3.Interop.e3CloneInterface _raw;
        private bool _disposed;

        public e3CloneInterface(Zuken.E3.Interop.e3CloneInterface raw)
        {
            _raw = raw;
        }

        public Zuken.E3.Interop.e3CloneInterface RawObject => _raw;

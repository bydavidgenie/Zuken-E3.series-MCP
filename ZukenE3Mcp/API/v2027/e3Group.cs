...
namespace ZukenE3Mcp.API.v2027
{
    public class e3Group : IDisposable
    {
        ...
        public int UpdateDrawingForProjectGenerationEx(uint flags, ref object substitutes, ref object allowedTexttypes, ref object allowedAttributenames, ref object resultArray)
        {
            object local_substitutes = substitutes;
            object local_allowedTexttypes = allowedTexttypes;
            object local_allowedAttributenames = allowedAttributenames;
            object local_resultArray = resultArray;
            var retVal = StaThreadExecutor.Instance.Execute(() => _raw.UpdateDrawingForProjectGenerationEx(flags, ref local_substitutes, ref local_allowedTexttypes, ref local_allowedAttributenames, ref local_resultArray));
            substitutes = local_substitutes;
            allowedTexttypes = local_allowedTexttypes;
            allowedAttributenames = local_allowedAttributenames;
            resultArray = local_resultArray;

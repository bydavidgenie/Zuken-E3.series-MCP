...
namespace ZukenE3Mcp.API.v2027
{
    public class e3Job : IDisposable
    {
        ...
        public e3ProjectConfigurator CreateProjectConfiguratorObject()
        {
            var rawResult = StaThreadExecutor.Instance.Execute(() => _raw.CreateProjectConfiguratorObject());
            return rawResult != null ? new e3ProjectConfigurator((Zuken.E3.Interop.e3ProjectConfigurator)rawResult) : null;
        }
        ...
        public e3SheetReference CreateSheetReferenceObject()
        {
            var rawResult = StaThreadExecutor.Instance.Execute(() => _raw.CreateSheetReferenceObject());
            return rawResult != null ? new e3SheetReference((Zuken.E3.Interop.e3SheetReference)rawResult) : null;
        }
        ...
        public int ExportRedlinerInformation(string filename, int flags)
        {
            return StaThreadExecutor.Instance.Execute(() => _raw.ExportRedlinerInformation(filename, flags));
        }
        ...
        public int FocusOnIds(ref object focusIds, int focushighlight, int focushighlightColour)
        {
            object local_focusIds = focusIds;
            var retVal = StaThreadExecutor.Instance.Execute(() => _raw.FocusOnIds(ref local_focusIds, focushighlight, focushighlightColour));
            focusIds = local_focusIds;
            return retVal;
        }
        ...
        public int Get3DAnimationEnabled()
        {
            return StaThreadExecutor.Instance.Execute(() => _raw.Get3DAnimationEnabled());
        }
        ...
        public int GetLockedObjects(ref object ids, int flags)
        {
            object local_ids = ids;
            var retVal = StaThreadExecutor.Instance.Execute(() => _raw.GetLockedObjects(ref local_ids, flags));
            ids = local_ids;
            return retVal;
        }
        ...
        public int GetProjectData(out object data, ref object configuration, ref object update_data)
        {
            object local_data = default;
            object local_configuration = configuration;
            object local_update_data = update_data;
            var retVal = StaThreadExecutor.Instance.Execute(() => _raw.GetProjectData(out local_data, ref local_configuration, ref local_update_data));
            data = local_data;
            configuration = local_configuration;
            update_data = local_update_data;
            return retVal;
        }
        ...
        public int HasLockedObjects(int flags)
        {
            return StaThreadExecutor.Instance.Execute(() => _raw.HasLockedObjects(flags));
        }
        ...
        public int ImportRedlinerInformation(string filename, int flags)
        {
            return StaThreadExecutor.Instance.Execute(() => _raw.ImportRedlinerInformation(filename, flags));
        }
        ...
        public int Set3DAnimationEnabled(int newval)
        {
            return StaThreadExecutor.Instance.Execute(() => _raw.Set3DAnimationEnabled(newval));
        }
        ...
        public int UpdateAllComponentsAttributes()
        {
            return StaThreadExecutor.Instance.Execute(() => _raw.UpdateAllComponentsAttributes());
        }

...
namespace ZukenE3Mcp.API.v2027
{
    public class e3Sheet : IDisposable
    {
        ...
        public int GetDeviceIdsFrom2DManufacturingView(out object deviceIds, int flags)
        {
            object local_deviceIds = default;
            var retVal = StaThreadExecutor.Instance.Execute(() => _raw.GetDeviceIdsFrom2DManufacturingView(out local_deviceIds, flags));
        ...
        public int GetPreferSinglePinPlacement()
        {
            return StaThreadExecutor.Instance.Execute(() => _raw.GetPreferSinglePinPlacement());
        }
        ...
        public int Is2DManufacturingView(int flags)
        {
            return StaThreadExecutor.Instance.Execute(() => _raw.Is2DManufacturingView(flags));
        }
        ...
        public int SetPreferSinglePinPlacement(int prefer_single_pin_placement)
        {
            return StaThreadExecutor.Instance.Execute(() => _raw.SetPreferSinglePinPlacement(prefer_single_pin_placement));
        }
